    ...
    if (all_trades[i].action == "b") {
        ...
        if (all_trades[j].package_price < all_trades[i].package_price) {
            ...
            if (all_trades[i].quantity > all_trades[j].quantity) {
                ...
                outFilei<< starting_time << " " << brokerName << " SELL " << all_trades[i].companyName << " $" << all_trades[i].package_price << " #" << all_trades[j].quantity << " " << all_trades[i].expiration_period<<endl;
                outFilej<< starting_time << " " << brokerName << " BUY " << all_trades[i].companyName << " $" << all_trades[j].package_price << " #" << all_trades[j].quantity << " " << all_trades[j].expiration_period<<endl;
            }
            else if (all_trades[j].quantity > all_trades[i].quantity) {
                total_profit += all_trades[i].quantity*(all_trades[i].package_price - all_trades[j].package_price);
                all_trades[j].quantity -= all_trades[i].quantity;
                all_trades[i].participating = false;
                outFilei<< starting_time << " " << brokerName << " SELL " << all_trades[i].companyName << " $" << all_trades[i].package_price << " #" << all_trades[i].quantity << " " << all_trades[i].expiration_period<<endl;
                outFilej<< starting_time << " " << brokerName << " BUY " << all_trades[i].companyName << " $" << all_trades[j].package_price << " #" << all_trades[i].quantity << " " << all_trades[j].expiration_period<<endl;
            }
            else {
                total_profit += all_trades[j].quantity*(all_trades[i].package_price - all_trades[j].package_price);
                all_trades[i].participating = false;
        ...
        if (all_trades[i].package_price < all_trades[j].package_price) {
            ...
            if (all_trades[i].quantity > all_trades[j].quantity) {
                ...
                outFilei<< starting_time << " " << brokerName << " BUY " << all_trades[i].companyName << " $" << all_trades[i].package_price << " #" << all_trades[j].quantity << " " << all_trades[i].expiration_period<<endl;
                outFilej<< starting_time << " " << brokerName << " SELL " << all_trades[i].companyName << " $" << all_trades[j].package_price << " #" << all_trades[j].quantity << " " << all_trades[j].expiration_period<<endl;
            }
            else if (all_trades[j].quantity > all_trades[i].quantity) {
                total_profit += all_trades[i].quantity*(all_trades[j].package_price - all_trades[i].package_price);
                all_trades[j].quantity -= all_trades[i].quantity;
                all_trades[i].participating = false;
                outFilei<< starting_time << " " << brokerName << " BUY " << all_trades[i].companyName << " $" << all_trades[i].package_price << " #" << all_trades[i].quantity << " " << all_trades[i].expiration_period<<endl;
                outFilej<< starting_time << " " << brokerName << " SELL " << all_trades[i].companyName << " $" << all_trades[j].package_price << " #" << all_trades[i].quantity << " " << all_trades[j].expiration_period<<endl;
            }
            else {
                total_profit += all_trades[j].quantity*(all_trades[j].package_price - all_trades[i].package_price);
                all_trades[i].participating = false;
